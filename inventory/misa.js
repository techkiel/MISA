...
app.config(function($routeProvider, $locationProvider) {
  ...
  $routeProvider.when('/inv',    {templateUrl: "inv.html"}); 
  $routeProvider.when('/viewinv',    {templateUrl: "viewinv.html"}); 
  $routeProvider.when('/viewmiss',      {templateUrl: "viewmiss.html"}); 
  $routeProvider.when('/report', {templateUrl: "report.html"}); 
  $routeProvider.when('/bug',   {templateUrl: "bug.html"}); 
